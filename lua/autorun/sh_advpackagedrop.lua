...
item_ammo_ar2={assembleTime=5, name="AR2 Ammo (20 rounds)"},
item_ammo_357_large={assembleTime=12, name=".357 Ammo (20 rounds)"},
item_ammo_357={assembleTime=5, name=".357 Ammo (6 rounds)"},
item_ammo_ar2_altfire={assembleTime=2, name="Combine Ball"},
